...
const getImages = (query) => {
    ...
    fetch(`https://pixabay.com/api/?key=${KEY}=${query}&image_type=photo&pretty=true`)
        ...
        .then(data => showImages(data.hits)) // 1st bug fix from this line
...
const createSlider = () => {
  ...
  `;
    ...
    const duration = document.getElementById('duration').value || 1000; // 2nd bug fix from this line, id spelling was not match with HTML file
...
// Press Enter button for search instant:
